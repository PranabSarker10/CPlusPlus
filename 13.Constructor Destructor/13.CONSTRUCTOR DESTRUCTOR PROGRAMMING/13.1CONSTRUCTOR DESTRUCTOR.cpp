...
rectangle::rectangle() ///As constructor has no return so there is no return type. And the name of the class and function is same.
{
    height = 0;
    width = 0;
...
int main()
{
    rectangle obj;///As we declared a object here so function will be called.
